...
class FDiscriminator_VGG_128(nn.Module):
    def __init__(self, in_nc, nf):
        super(FDiscriminator_VGG_128, self).__init__()
        # [64, 128, 128]
        self.conv0_0 = nn.Conv2d(in_nc, nf, 3, 1, 1, bias=True)
        self.conv0_1 = nn.Conv2d(nf, nf, 4, 2, 1, bias=False)
        self.bn0_1 = nn.BatchNorm2d(nf, affine=True)
...
class FDLeakyVGG(nn.Module):
    def __init__(self):
        super(FDLeakyVGG, self).__init__()
        self.conv1 = nn.Conv2d(256, 256, 3, stride=1, padding=1)

        self.conv2 = nn.Conv2d(256, 256, 3, stride=2, padding=1)
        self.bn2 = nn.BatchNorm2d(256)
        self.conv3 = nn.Conv2d(256, 256*2, 3, stride=1, padding=1)
        self.bn3 = nn.BatchNorm2d(256*2)
        self.conv4 = nn.Conv2d(256*2, 256*2, 3, stride=2, padding=1)
        self.bn4 = nn.BatchNorm2d(256*2)
        self.conv5 = nn.Conv2d(256*2, 256*4, 3, stride=1, padding=1)
        self.bn5 = nn.BatchNorm2d(256*4)
        self.conv6 = nn.Conv2d(256*4, 256*4, 3, stride=2, padding=1)
        self.bn6 = nn.BatchNorm2d(256*4)
        self.conv7 = nn.Conv2d(256*4, 256*8, 3, stride=1, padding=1)
        self.bn7 = nn.BatchNorm2d(256*8)
        self.conv8 = nn.Conv2d(256*8, 256*8, 3, stride=2, padding=1)
        self.bn8 = nn.BatchNorm2d(256*8)

        # Replaced original paper FC layers with FCN
        self.conv9 = nn.Conv2d(256*8, 1, 1, stride=1, padding=1)
        self.lrelu = nn.LeakyReLU(negative_slope=0.2, inplace=True)
